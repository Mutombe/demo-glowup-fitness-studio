    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-black">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <AnimatePresence mode="sync">
          <motion.img key={currentSlide} src={heroImages[currentSlide]} alt="GlowUp fitness studio"
...
function StatsSection() {
  ...
  const ds = stats?.length ? stats : [{ number: '1', label: 'Reviews' }, { number: '5', label: 'Rating' }, { number: '600', label: 'Members' }, { number: '30', label: 'Classes/Week' }];
  return (
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1200&q=80" alt="GlowUp fitness studio" className="w-full h-[130%] object-cover object-center" loading="eager" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href={`https://wa.me/${business.whatsappNumber || '263784868636'}`} target="_blank" rel="noopener noreferrer"
